...
import type { Course, CurrencyCode, Faculty, Language } from '../types';
...
export function Catalog({ courses, loading, error, faculty, lang, currency, rate, text, onFaculty, onOrder }: Props) {
      ...
      {loading ? (
        ...
        <>
          <div className="course-grid">
            {sorted.slice(0, visible).map((course) => <CourseCard key={course.code} course={course} lang={lang} currency={currency} rate={rate} text={text} onOrder={onOrder} />)}
          </div>
